<template>
  <div>
      ...
      <div class="card-header" :id="'heading' + index">
        <div class="row align-items-center">
          <div class="col-md-9">
            ...
            <div class="input-group mb-3 d-none" :id="'taskInputGroup' + index">
              <input
                type="text"
                class="form-control"
                :id="'taskInput' + index"
          ...
          <div class="col-md-3">
            <div class="controlOptions">
              ...
              <span
                class="finished-task"
                v-else-if="checkActive(start, end) === 'finished'"
              >
                Finished
              </span>
              <span
                class="start-soon-task"
                v-else-if="checkActive(start, end) === 'startSoon'"
              >
                Soon
              </span>
              ...
              <div class="remove-task">
                <button class="close" @click="removeTask(index)">
    ...
    <!-- <div class="card">
            <div class="card-top"> -->
    <!-- <span class="task-is-active">
                    {{ statusStrings[checkActive(start, end)] }}
                </span> -->
    <!-- </div> -->
    <!-- <div class="remove-task">
                <button class="close" @click="removeTask(index)">
...
export default defineComponent({
  ...
  data: () => {
    return {
      ...
      //     finished: "Finished",
      //     active: "Active",
      //     startSoon: "will start soon",
      //     noTime: "No Due Date Available",
      // },
  ...
  methods: {
    ...
    updateTaskStart: function (index) {
      ...
      newTasks[index].start = document.getElementById(
        `taskInputStart${index}`
      ).value;
      localStorage.setItem("tasks", JSON.stringify(newTasks));
    ...
    updateTaskEnd: function (index) {
      ...
      newTasks[index].end = document.getElementById(
        `taskInputEnd${index}`
      ).value;
      localStorage.setItem("tasks", JSON.stringify(newTasks));
